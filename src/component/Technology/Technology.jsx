...
export default function Technology() {
  ...
  const urlApi = `https://newsapi.org/v2/top-headlines?country=${countrys}&category=${category}&apiKey=${apikey}`

  async function getNewsTecnologe() {
    setLoading(true);
    const dataTecnology = await Axios.get(urlApi);
    setDataNews(dataTecnology.data.articles);
    setCountry(countrys)
